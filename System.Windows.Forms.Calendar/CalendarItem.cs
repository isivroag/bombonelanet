...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarSelectableElement
    {
        ...
        /// /// <param name="folio">Text of the item</param>
        public CalendarItem(Calendar calendar, DateTime startDate, DateTime endDate, string text, string folio)
            : this(calendar)
        {
            StartDate = startDate;
            EndDate = endDate;
        ...
        /// <param name="text">Text of the item</param>
        /// /// <param name="folio">Text of the item</param>
        public CalendarItem(Calendar calendar, DateTime startDate, TimeSpan duration, string text,string folio)
            : this(calendar, startDate, startDate.Add(duration), text,folio)
        { }
