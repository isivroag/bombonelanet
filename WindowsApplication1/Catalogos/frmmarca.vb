...
Public Class frmmarca
    ...
    Public Sub mostrar(ByVal registro As c_marca)
        datos = registro
        tid.Text = registro.Id_marca
        tnombre.Text = registro.Nom_marca
    End Sub
    ...
    Private Sub bguardar_Click(sender As Object, e As EventArgs) Handles bguardar.Click
        If Strings.Len(tnombre.Text) > 0 Then
            datos.Nom_marca = UCase(tnombre.Text)
    ...
    Private Sub frmmarca_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        inicial(sender, e, "CATALOGO DE MARCAS")
        limpiar()
    End Sub
End Class