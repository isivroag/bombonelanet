...
Public Class frmservicio
    ...
    Private Sub bguardar_Click(sender As Object, e As EventArgs) Handles bguardar.Click
        If Strings.Len(tnombre.Text) > 0 And Len(ctipo.Text) > 0 And Len(tdur.Text) > 0 Then
    ...
    Private Sub frmservicio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        inicial(sender, e, "CATALOGO DE SERVICIOS")
        limpiar()
        combo()
    End Sub
    ...
    Private Sub tdur_KeyPress(sender As Object, e As KeyPressEventArgs) Handles tdur.KeyPress
