...
Public Class frmproducto
    ...
    Private Sub bguardar_Click(sender As Object, e As EventArgs) Handles bguardar.Click
        If Strings.Len(tnombre.Text) > 0 And Len(tprecio.Text) > 0 And Len(tcosto.Text) > 0 And Len(tclave.Text) > 0 And Len(cunidad.Text) > 0 Then
    ...
    Private Sub frmproducto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        inicial(sender, e, "CATALOGO DE PRODUCTOS")
        limpiar()
        combo()
    End Sub
    ...
    Private Sub tcosto_TextChanged(sender As Object, e As EventArgs) Handles tcosto.TextChanged
