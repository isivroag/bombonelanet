...
Public Class frmtipo
    ...
    Dim texto As String
    Dim datos As New c_tipo
    Dim tabla As New DataTable
    Public flag As Integer

    Public Sub mostrar(ByVal registro As c_tipo)
        datos = registro
        tid.Text = registro.Id_tipo
        tnombre.Text = registro.Nom_tipo
    End Sub
    ...
    Private Sub bguardar_Click(sender As Object, e As EventArgs) Handles bguardar.Click
        If Strings.Len(tnombre.Text) > 0 Then
            datos.Nom_tipo = UCase(tnombre.Text)
            ...
            Else
                conn = New c_mysqlconn
                If conn.modificar(datos, datos.Id_tipo.ToString) Then
                    MessageBox.Show("Datos Guardados", "Operacion Exitosa", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    frmcntatipos.consulta()
                    Me.Dispose()
                Else
    ...
    Private Sub frmtipo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        inicial(sender, e, "CATALOGO DE TIPOS")
        limpiar()
    End Sub
End Class